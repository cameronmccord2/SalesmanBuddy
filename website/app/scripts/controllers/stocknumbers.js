...
.controller('StocknumbersCtrl', ['$scope', '$q', '$location', '$timeout', '$routeParams', 'stockNumbersFactory', 'dealershipsFactory', 'usersFactory', 'User', 'rightsUpperSBUser', 'rightsSalesman', 'rightsManager', 'rightsSBUser', 
	function ($scope, $q, $location, $timeout, $routeParams, stockNumbersFactory, dealershipsFactory, usersFactory, User, rightsUpperSBUser, rightsSalesman, rightsManager, rightsSBUser) {
