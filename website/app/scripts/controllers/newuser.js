...
.controller('NewuserCtrl', ['$scope', '$routeParams', '$location', 'usersFactory', 'User', 'dealershipsFactory', 'errorFactory', 'statesFactory', function ($scope, $routeParams, $location, usersFactory, User, dealershipsFactory, errorFactory, statesFactory) {
