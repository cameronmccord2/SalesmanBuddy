...
angular.module('salesmanBuddyApp')
  .controller('TestdriveslistCtrl', ['$scope', 'licensesFactory', 'User', 'dealershipsFactory', 'usersFactory', function ($scope, licensesFactory, User, dealershipsFactory, usersFactory) {
