...
.controller('ReportsmanagerCtrl', ['$scope', 'User', 'dealershipsFactory', 'userTreeFactory', 'usersFactory', '$q', 'reportsFactory', 'rightsUpperSBUser', 'rightsSalesman', 'rightsManager', 'rightsSBUser', 
	function ($scope, User, dealershipsFactory, userTreeFactory, usersFactory, $q, reportsFactory, rightsUpperSBUser, rightsSalesman, rightsManager, rightsSBUser) {
